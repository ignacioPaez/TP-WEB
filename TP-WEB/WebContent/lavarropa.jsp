...
<body>
    ...
    <form method="POST" action='ControladorLavarropa' name="frmAddUser">
        ...
        <c:set var="colores" value="Blanco,Negro,ccc,Azul,eee,Gris,Rojo" />
       ...
       Consumo : <select name="consumo" id="consumo">
        ...
        Carga : <input type="text" name="carga" value="<c:out value="${lavarropa.carga}" />" /> <br />  <input
